...
ap.add_argument("-f", "--recordframes", help="If record Videos enable, set the frame rate ( default is 4 to better performance )", type=int, default=4)
...
ap.add_argument("-i", "--invertbracelets", help="Invert Bracelets left/right", action='store_true')
